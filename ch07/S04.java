...
// // 스킬마다 바뀔 수 있는 부분 name, point, champ는 필드(멤버변수)로 작성
// class Skill {
...
// public 애쉬() {
// // 1. 상속 받는 객체가 생성
// // 2. super를 통해 객체 안의 필드에 값을 초기화
// super(100, null);
// // 3. 현재 class의 객체가 생성
// // 4. 햔제 객체 안의필드에 값을 넣어줌
...
// int damage = (int) (50 + (40 * (point - 1)) + (this.champ.ad * (1.25 + (0.2 *
// (point - 1)))));
...
// // // 초기화를 해주려고 햐는 경우 null사용
// // String str = null;
// // System.out.println(str);
// // str = new String("홍길동");
// // System.out.println(str);
// // // 더 이상 쓸모 없는 객체에 null을 입력함
// // str=null;
